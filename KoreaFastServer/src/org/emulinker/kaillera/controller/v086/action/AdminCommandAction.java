...
public class AdminCommandAction implements V086Action
{
	...
	private void processHelp(String message, KailleraServerImpl server, KailleraUserImpl admin, V086Controller.V086ClientHandler clientHandler) throws ActionException, MessageFormatException
	{
		...
		try { Thread.sleep(20); } catch(Exception e) {}
		clientHandler.send(new InformationMessage(clientHandler.getNextMessageNumber(), "server", EmuLang.getString("AdminCommandAction.triviaon"))); //$NON-NLS-1$ //$NON-NLS-2$
		...
		try { Thread.sleep(20); } catch(Exception e) {}
		clientHandler.send(new InformationMessage(clientHandler.getNextMessageNumber(), "server", EmuLang.getString("AdminCommandAction.triviaoff"))); //$NON-NLS-1$ //$NON-NLS-2$
		...
		try { Thread.sleep(20); } catch(Exception e) {}
		clientHandler.send(new InformationMessage(clientHandler.getNextMessageNumber(), "server", EmuLang.getString("AdminCommandAction.stealthon"))); //$NON-NLS-1$ //$NON-NLS-2$
		...
		if(admin.getAccess() == AccessManager.ACCESS_SUPERADMIN){
			clientHandler.send(new InformationMessage(clientHandler.getNextMessageNumber(), "server", EmuLang.getString("AdminCommandAction.tempelevated"))); //$NON-NLS-1$ //$NON-NLS-2$
			...
			try { Thread.sleep(20); } catch(Exception e) {}
			clientHandler.send(new InformationMessage(clientHandler.getNextMessageNumber(), "server", EmuLang.getString("AdminCommandAction.tempmoderator"))); //$NON-NLS-1$ //$NON-NLS-2$
			...
			try { Thread.sleep(20); } catch(Exception e) {}
			clientHandler.send(new InformationMessage(clientHandler.getNextMessageNumber(), "server", EmuLang.getString("AdminCommandAction.clear"))); //$NON-NLS-1$ //$NON-NLS-2$
