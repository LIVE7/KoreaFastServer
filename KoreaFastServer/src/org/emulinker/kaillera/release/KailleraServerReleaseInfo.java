...
public final class KailleraServerReleaseInfo implements ReleaseInfo
{
	...
	public String getWelcome()
	{
		...
		sb.append(EmuUtil.LB);
		sb.append("// Homepage: " + getWebsiteString());
		return sb.toString();
	}
}
