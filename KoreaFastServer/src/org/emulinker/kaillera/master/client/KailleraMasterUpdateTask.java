...
public class KailleraMasterUpdateTask implements MasterListUpdateTask
{
	...
	public void touchMaster()
	{
		...
		params[4] = new NameValuePair("version", "KFS_" + releaseInfo.getVersionString());
		...
		///
		String qs = org.apache.commons.httpclient.util.EncodingUtil.formUrlEncode(params, System.getProperty("emulinker.charset"));
		kailleraTouch.setQueryString(qs);
